...
<head>
    ...
    <title>Nakhrali || Forgot Password</title>
        ...
        <div class="signin-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-2 d-lg-block d-none">
                    <a href="{{ redirect()->back()->getTargetUrl() }}" class="back-btn"><i
                            class="far fa-angle-left"></i></a>
                </div>
                <div class="col-xl-6 col-lg-4 col-sm-6">
                    <div class="singin-header-btn">
                        <p>Already a member?</p>
                        <a href="{{ route('frontend.auth.login') }}" class="sign-up-btn axil-btn btn-bg-secondary">Sign
                            In</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 offset-xl-2">
                <div class="axil-signin-form-wrap">
                    <div class="axil-signin-form">
                        ...
                        <form class="singin-form" id="forgotPasswordForm"
                            action="{{ route('frontend.auth.forgot_password_process') }}" method="POST">
                            @csrf
                            @method('POST')
